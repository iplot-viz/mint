...
def test_waypoint_initialization():
    ...
    """
    waypoint = Waypoint(idx=1, col_num=2, row_num=3, col_span=4, row_span=5, stack_num=6, signal_stack_id=7, ts_start=8, ts_end=9, func=None, args=[], kwargs={})
