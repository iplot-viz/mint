...
<style>
  ...
  img {{ max-width: 900px; max-height: 480px; display: block; margin: 0 auto; height: auto; }}
  img.inline-icon {{ max-width: none; max-height: none; vertical-align: middle; height: 18px; display: inline; margin: 0; border: 0; }}
