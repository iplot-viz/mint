...
class MTSignalsModel(QAbstractItemModel):
    ...
    def create_signals(self, row_idx: int, stack) -> typing.Iterator[Waypoint]:
        ...
        for i, parsed_row in enumerate(
            ...
            if signal_params['plot_type'] in ('PlotXY', 'PlotXYWithSlider', 'PlotImage', 'PlotImageWithSlider'):
                        ...
                        # Stack
                            ...
                            if value == '':
                                ...
                                logger.warning(
                                    ...
                                    f"Plot of type PlotContour, PlotContourWithSlider, PlotImage, PlotImageWithSlider or PlotXYWithSlider cannot be stacked, just PlotXY.\n"
